...
export class DishService {
    ...
    async createDish(dish: Dish,file): Promise<Dish> {
     ...
     return  this.prismaService.dish.create({data: {...dish, image: img.Location, price:Number(dish.price),weight:Number(dish.weight),localityId:Number(dish.localityId)}})
    }
